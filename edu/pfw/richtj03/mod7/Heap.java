...
public class Heap<E extends Comparable<E>> {
    ...
    private void reheapifyDown(int index) {
        while (index < size) { // Avoid out of bounds
            ...
            /*
             * TODO Swap with the largest child and continue down the tree if the current
             * node is smaller
             */
    ...
    public static void main(String[] args) throws InterruptedException {
         ...
         * Priority 2: Alice - Puncture wound (Risk Level: 2) -> David - Bone Fracture
         * (Risk Level: 2),
         * Priority 3: Charlie - Heart Attack (Risk Level: 3) -> Eve - Seizures (Risk
         * Level: 3)]
         */
